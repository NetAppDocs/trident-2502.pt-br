...
[[netapp-hcisolidfire-backend-drivers]]
...
Trident usa o  `azure-netapp-files` driver para gerenciar o serviço link:https://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Files"^].
...
[[emulating-different-service-levelsqos]]
