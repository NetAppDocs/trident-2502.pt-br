...
Para obter informações sobre FlexGroups e cargas de trabalho que são apropriadas para FlexGroups, consulte o  https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["Guia de práticas recomendadas e implementação do volume NetApp FlexGroup"^].
