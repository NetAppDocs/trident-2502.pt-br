...
* Um problema comum que você pode encontrar ao usar Trident https://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Files"] é quando os segredos do locatário e do cliente vêm de um registro de aplicativo com permissões insuficientes. Para obter uma lista completa dos requisitos do Trident, consulte a link:trident-use/anf.html["Azure NetApp Files"]configuração.
