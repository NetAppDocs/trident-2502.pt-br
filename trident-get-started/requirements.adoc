...
* FAS, AFF ou ASA r2 locais (iSCSI, NVMe/TCP e FC) executando versões do ONTAP sob suporte total ou limitado da NetApp. Consulte link:https://mysupport.netapp.com/site/info/version-support["Suporte à versão de software"].
