...
.Antes de começar
Além do link:trident-install/kubernetes-deploy.html#before-you-begin["pré-requisitos de implantação"] você precisa de link:https://v3.helm.sh/["Helm versão 3"^].
