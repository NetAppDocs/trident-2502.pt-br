...
| -- | Outubro de 2026 | Outubro de 2027 
...
NOTE: Para obter o cronograma de suporte da versão mais recente do Trident, consulte o  https://docs.netapp.com/us-en/trident/get-help.html#trident-support-lifecycle["Página do ciclo de vida do suporte"^].
