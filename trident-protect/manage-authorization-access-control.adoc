...
summary: 'O Trident Protect utiliza o modelo Kubernetes de controle de acesso baseado em funções (RBAC). Você pode usar os recursos RBAC do Trident Protect para controlar o acesso aos recursos com mais precisão.' 
---
