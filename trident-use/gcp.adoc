...
Trident pode criar volumes do Cloud Volumes Service de duas maneiras link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["tipos de serviço"^]:

* *CVS-Performance*: O tipo de serviço Trident padrão. Este tipo de serviço otimizado para desempenho é ideal para cargas de trabalho de produção que priorizam o desempenho. O tipo de serviço CVS-Performance é uma opção de hardware que suporta volumes com tamanho mínimo de 100 GiB. Você pode escolher uma das seguintes opções link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["três níveis de serviço"^]:
+
** `standard`
** `premium`
** `extreme`
...
* *CVS*: O tipo de serviço CVS oferece alta disponibilidade zonal com níveis de desempenho limitados a moderados. O tipo de serviço CVS é uma opção de software que utiliza pool de storage para suportar volumes a partir de 1 GiB. O pool de storage pode conter até 50 volumes, onde todos os volumes compartilham a capacidade e o desempenho do pool. Você pode escolher uma das seguintes opções link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["dois níveis de serviço"^]:
+
** `standardsw`
...
Para configurar e usar o  https://www.netapp.com/google-cloud/netapp-volumes/["Cloud Volumes Service para Google Cloud"^]backend, você precisa do seguinte:
