...
| `luksEncryption` | Ative a criptografia LUKS. Consulte o link: consulte link:../trident-reco/security-luks.html["Usar a configuração de chave unificada do Linux (LUKS)"]. Somente SAN. | "" 
