...
Utilizando o [`tridentctl` utilitário, você pode executar o  `get` comando para obter volumes subordinados. Para mais informações, consulte link:../trident-managing-k8s/tridentctl.html[`tridentctl` comandos e opções].
