...
| `luksEncryption` | Ative LUKS criptografia. Consulte link:../trident-reco/security-luks.html["Usar a configuração de chave unificada do Linux (LUKS)"]. Somente SAN. | "" 
